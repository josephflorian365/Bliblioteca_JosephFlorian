...
public class AlertMaker {
    ...
    public static void showErrorMessage(Exception ex) {
        ...
        Label label = new Label("La excepción stacktrace fue:");
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            TrayIcon trayIcon = new TrayIcon(image, "Asistente de Biblioteca");
            trayIcon.setImageAutoSize(true);
            trayIcon.setToolTip("Asistente de Biblioteca");
            tray.add(trayIcon);
